...
class AIAnalysisCache
{
    ...
    public function save(int $userId, string $datePreset, ?string $dateFrom, ?string $dateTo, string $analysisText): bool
    {
        $existing = $this->getByFilter($userId, $datePreset, $dateFrom, $dateTo);
        ...
        $stmt = $this->db->prepare("
            INSERT INTO ai_analysis_cache (user_id, date_preset, date_from, date_to, analysis_text)
            VALUES (:user_id, :date_preset, :date_from, :date_to, :analysis_text)
        ");
